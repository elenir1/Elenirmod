...
namespace Elenirmod.Items.Armours
{
    ...
    public class Eleaussiehelmetdev : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Ele's Aussie Helmet");
            Tooltip.SetDefault(
                "5% increased melee critical strike chance\n" +
                "G'day Mate, quite a pretty helmet you've got there ya cunt.");
        }
        ...
        {
            return head.type == ItemType<Eleaussiehelmetdev>()
